...
BPE_CODES=$GRAMMARS_PATH/bpe_codes_s$SRC_NAME-LEX0-t$TGT_NAME-lex$LEXICON

CONCAT_BPE=$GRAMMARS_PATH/all.s$SRC_NAME-LEX0-t$TGT_NAME-LEX$LEXICON.$CODES

SRC_VOCAB=$GRAMMARS_PATH/vocab.s$SRC_NAME-LEX0.$CODES
TGT_VOCAB=$GRAMMARS_PATH/vocab.t$TGT_NAME-LEX$LEXICON.$CODES
FULL_VOCAB=$GRAMMARS_PATH/vocab.s$SRC_NAME-LEX0-t$TGT_NAME-LEX$LEXICON.$CODES

SRC_VALID=$GRAMMARS_PATH/valid/sample_$SRC_NAME.txt
SRC_TEST=$GRAMMARS_PATH/test/sample_$SRC_NAME.txt

SRC_VALID_TOK=$GRAMMARS_PATH/valid/sample_s$SRC_NAME-LEX0.tok
SRC_TEST_TOK=$GRAMMARS_PATH/test/sample_s$SRC_NAME-LEX0.tok
TGT_VALID_TOK=$GRAMMARS_PATH/valid/sample_t$TGT_NAME-LEX$LEXICON.tok
TGT_TEST_TOK=$GRAMMARS_PATH/test/sample_t$TGT_NAME-LEX$LEXICON.tok
