...
TGT_NAME=000000
LEXICON=1
EXP_NAME='GR_s'$SRC_NAME'.LEX0.t'$TGT_NAME'.LEX'$LEXICON
...
SRC_TOK=$GRAMMARS_PATH/$EXP_NAME/sample_s$SRC_NAME.LEX0.tok # Always lexicon 0 as source
TGT_TOK=$GRAMMARS_PATH/$EXP_NAME/sample_t$TGT_NAME.LEX$LEXICON.tok
  
BPE_CODES=$GRAMMARS_PATH/$EXP_NAME/bpe_codes_s$SRC_NAME.LEX0-t$TGT_NAME.LEX$LEXICON

CONCAT_BPE=$GRAMMARS_PATH/$EXP_NAME/all.s$SRC_NAME.LEX0-t$TGT_NAME.LEX$LEXICON.$CODES

SRC_VOCAB=$GRAMMARS_PATH/$EXP_NAME/vocab.s$SRC_NAME.LEX0.$CODES
TGT_VOCAB=$GRAMMARS_PATH/$EXP_NAME/vocab.t$TGT_NAME.LEX$LEXICON.$CODES
FULL_VOCAB=$GRAMMARS_PATH/$EXP_NAME/vocab.s$SRC_NAME.LEX0-t$TGT_NAME.LEX$LEXICON.$CODES

SRC_VALID=$GRAMMARS_PATH/valid/sample_$SRC_NAME.txt
SRC_TEST=$GRAMMARS_PATH/test/sample_$SRC_NAME.txt

SRC_VALID_TOK=$GRAMMARS_PATH/$EXP_NAME/valid/sample_s$SRC_NAME.LEX0.tok
SRC_TEST_TOK=$GRAMMARS_PATH/$EXP_NAME/test/sample_s$SRC_NAME.LEX0.tok
TGT_VALID_TOK=$GRAMMARS_PATH/$EXP_NAME/valid/sample_t$TGT_NAME.LEX$LEXICON.tok
TGT_TEST_TOK=$GRAMMARS_PATH/$EXP_NAME/test/sample_t$TGT_NAME.LEX$LEXICON.tok
